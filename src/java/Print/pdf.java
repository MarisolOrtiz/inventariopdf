    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            try{
                ...
                par2.add(new Phrase("Categorias enlistadas",fdesc));
                ...
                PdfPCell celda1 = new PdfPCell(new Paragraph("Codigo",FontFactory.getFont("Arial",11,Font.ITALIC,BaseColor.BLUE)));
                PdfPCell celda2 = new PdfPCell(new Paragraph("Nombres",FontFactory.getFont("Arial",11,Font.ITALIC,BaseColor.BLUE)));
                PdfPCell celda3 = new PdfPCell(new Paragraph("Estado",FontFactory.getFont("Arial",11,Font.ITALIC,BaseColor.BLUE)));
       ...
       java.util.List<Categoria> listar = categoria.Listar();
        ...
        for ( Categoria categoriaListar : listar) {
            ...
            tabla.addCell(v2);//lo mismo que el primer valor
                ...
                Font ftitulo2 = new Font(Font.FontFamily.HELVETICA,12,Font.ITALIC,BaseColor.RED);
                par3.add(new Phrase(Chunk.NEWLINE));
                par3.add(new Phrase(Chunk.NEWLINE));
                par3.add(new Phrase("Link: https://github.com/MarisolOrtiz/inventariopdf",ftitulo2));
